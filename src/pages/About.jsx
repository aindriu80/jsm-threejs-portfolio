    ...
    <section className="max-container">
      ...
      <div className="py-16">
        ...
        <div className="mt-5 flex flex-col gap-3 text-slate-500">
          <p>
            I've worked with a range of different kinds of companies and
            organizations, improving my skills and working with people from many
            backgrounds.
          </p>
        </div>
          ...
          <VerticalTimeline>
            {experiences.map((experience) => (
              ...
              >
                ...
                <ul className="my-5 list-disk ml-5 space-y-2">
